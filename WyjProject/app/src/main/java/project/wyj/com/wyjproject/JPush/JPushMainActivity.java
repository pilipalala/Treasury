package project.wyj.com.wyjproject.JPush;
...
import project.wyj.com.wyjproject.R;

public class JPushMainActivity extends BaseActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.getRegistrationId:
                ...
                if (!rid.isEmpty()) {
                    ...
                    Log.e("JPushInterface", "onClick: "+rid );
                } else {
