...
import com.umeng.soexample.share.adapter.ShareTypeAdapter;
...
//        music.setTitle("QQ音乐分享标题");
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        if (styles.get(i).toString().equals(StyleUtil.TEXT)) {//纯文本
            /*new ShareAction(ShareDetailActivity.this).withText("hello")
        ...
        } else if (styles.get(i).equals(StyleUtil.TEXTANDIMAGE)) {
            new ShareAction(ShareDetailActivity.this).withText(Defaultcontent.text)
