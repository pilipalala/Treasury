...
public class NetworkUtils {
    private NetworkUtils() {
        throw new UnsupportedOperationException("NetworkUtils 没有实例化");
    }
    ...
    public static void openWirelessSettings() {
        if (Build.VERSION.SDK_INT > 10) {
            ...
            Utils.getContext().startActivity(new Intent(Settings.ACTION_SEARCH_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    public static boolean isAvailableByPing() {
        ...
        ShellUtils.CommandResult result = ShellUtils.execCmd("ping -c 1 -w 223.5.5.5", false);
...
//            LogUtils
    ...
    public static boolean getDataEnabled() {
        try {
            TelecomManager tm = (TelecomManager) Utils.getContext().getSystemService(Context.TELECOM_SERVICE);
            Method getMoblieDataEnableMethod = tm.getClass().getDeclaredMethod("getDataEnabled");
            if (getMoblieDataEnableMethod != null) {
                return (boolean) getMoblieDataEnableMethod.invoke(tm);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
